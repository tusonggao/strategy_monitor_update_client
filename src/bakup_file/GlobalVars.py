...
#    GlobalVars.benchmark_IF.getLastTradeDayLastMinData('2017-3-2')
#    print(GlobalVars.benchmark_IF.getMarkePrice('09:30:00'))
#    
#    GlobalVars.index_IF.getLastTradeDayLastMinData('2017-3-2')
#    GlobalVars.index_IF.get1MinDataByDate('2017-3-2')
#    print(GlobalVars.index_IF.getMarkePrice('09:30:00'))
#    
#    GlobalVars.index_IC.getLastTradeDayLastMinData('2017-3-2')
#    GlobalVars.index_IC.get1MinDataByDate('2017-3-2')
#    print(GlobalVars.index_IC.getMarkePrice('09:30:00'))
#    
#    GlobalVars.index_IH.getLastTradeDayLastMinData('2017-3-2')
#    GlobalVars.index_IH.get1MinDataByDate('2017-3-2')
#    print(GlobalVars.index_IH.getMarkePrice('09:30:00'))
